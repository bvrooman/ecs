...
using field_type_t = std::remove_cvref_t<
    decltype(get_field<I>(std::declval<std::remove_cvref_t<T>&>()))>;
...
// A value convertible to anything; used to probe how many members an aggregate
// can be brace-initialized with.
struct any_field {
  template <class U>
...
constexpr auto field_tie(T& t) noexcept {
  ...
  static_assert(N <= 32, "ecs portable reflection supports up to 32 fields; "
                         "build with -DECS_USE_P2996=1 for unlimited fields");
  using std::tie;
  if constexpr (N == 0) {
    return tie();
  } else if constexpr (N == 1) {
    auto& [a] = t; return tie(a);
  } else if constexpr (N == 2) {
    auto& [a, b] = t; return tie(a, b);
  } else if constexpr (N == 3) {
    auto& [a, b, c] = t; return tie(a, b, c);
  } else if constexpr (N == 4) {
    auto& [a, b, c, d] = t; return tie(a, b, c, d);
  } else if constexpr (N == 5) {
    auto& [a, b, c, d, e] = t; return tie(a, b, c, d, e);
  } else if constexpr (N == 6) {
    auto& [a, b, c, d, e, f] = t; return tie(a, b, c, d, e, f);
  } else if constexpr (N == 7) {
    auto& [a, b, c, d, e, f, g] = t; return tie(a, b, c, d, e, f, g);
  } else if constexpr (N == 8) {
    auto& [a, b, c, d, e, f, g, h] = t; return tie(a, b, c, d, e, f, g, h);
    ...
    auto& [a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p,
           q, r, s, u, v, w, x, y, z, A, B, C, D, E, F, G] = t;
    if constexpr (N == 17)
...
template <class T, std::size_t I>
using field_type_t = std::remove_cvref_t<
    std::tuple_element_t<I, decltype(field_tie(std::declval<
