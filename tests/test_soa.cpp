...
struct Transform { Vec3 pos; float mass; int id; };
struct Wide { int a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r; };
struct Tag {};

static void reflection_counts() {
  static_assert(reflect::field_count_v<Vec3> == 3);
  static_assert(reflect::field_count_v<Transform> == 3);
  static_assert(reflect::field_count_v<Wide> == 18); // exercises 17..32 ladder
